...
{
    class triplex_node : Module
    {

        public triplex_node() { setupProperties(new List<Property>());}
        public triplex_node(triplex_node old) { m_p1 = old.FromPoint; m_p2 = old.StartPoint; m_p3 = old.EndPoint; m_p4 = old.ToPoint; setupProperties(old.Properties); }
        private void setupProperties(List<Property> prop)
        {
            ...
            DefaultProperties.Add(new Property("voltage_1", "", " complex"));
            DefaultProperties.Add(new Property("voltage_2", "", " complex"));
            DefaultProperties.Add(new Property("voltage_N", "0", " complex"));
        ...
        {
            wr.WriteStartElement("triplex_node");
        ...
        {
            return string.Format("triplex_node@{0}",
                StartPoint.PosAsString());
        }
        public override IDrawObject Clone()
        {
            return new triplex_node(this);
        }

        public override string Id
        {
            get { return "triplex_node"; }
        }
        public override string toGLM()
        {
            String s = "object triplex_node {" + System.Environment.NewLine;
