...
{
    class triplex_line  : Module
    {

        public triplex_line() { setupProperties(new List<Property>()); tofrom = true; }
        public triplex_line(triplex_line old) { m_p1 = old.FromPoint; m_p2 = old.StartPoint; m_p3 = old.EndPoint; m_p4 = old.ToPoint; setupProperties(old.Properties); tofrom = true; }
        ...
        {
            wr.WriteStartElement("triplex_line");
        ...
        {
            return string.Format("triplex_line@{0},{1} - L={2:f4}<{3:f4}",
        ...
        {
            return new triplex_line(this);
        }
        public override string toGLM()
        {
            String s = "object triplex_line {" + System.Environment.NewLine;
        ...
        public override void Draw(ICanvas canvas, RectangleF unitrect)
        {
            ...
            canvas.DrawLine(canvas, pen, new UnitPoint(m_p2.X + 0.05, m_p2.Y + 0.05), new UnitPoint(m_p3.X + 0.05, m_p3.Y + 0.05));
